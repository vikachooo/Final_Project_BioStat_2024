...
trend_choices <- c("Disease Structure Dynamics", "Thrombolysis Trend", "Mortality Trend")
...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      selectInput("trend", "Select Trend:", choices = trend_choices),
      selectInput("hospital", "Select Hospital:", choices = c("All Hospitals", unique(data$hosp))),
      selectInput("type", "Select Type:", choices = c("All Types", unique(data$type))),
